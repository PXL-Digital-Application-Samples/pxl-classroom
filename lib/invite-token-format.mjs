...
//
// invite_key / invite_pubkey are the signed-acceptance keypair (CLAIM_PLAN
// Phase A). The private half is the link secret; the public half is copied to
...
/** All three invitation fields, absent ones as "". */
