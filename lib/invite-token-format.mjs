...
// Internal: parseToken decodes through it and re-encodes to check canonicality.
// Callers outside this module want lib/base64url.mjs, which REFUSES a
// non-canonical spelling instead of leaving the check to them.
