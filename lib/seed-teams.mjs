...
export function planSeed({
  ...
  // Under `open` and `org_member` it predicts nothing, and telling a lecturer
  // their students will be rejected when they will not is worse than silence.
  if (roster && normalizeRosterMode(targetAssignment.roster_mode) === "enforced") {
    const known = new Set(
  ...
  // `enforced` only. Under `open` and `org_member` the roster may be empty or
