 ...
 *
 * @param {object[]|null} rosterStudents
 * @param {object} [opts]
 ...
 *
 * @param {object} [opts]
 * @param {object[]} [opts.sourceTeams]
 * @param {object[]} [opts.existingTeams]
 * @param {object|null} [opts.targetAssignment] the assignment being seeded INTO
 * @param {object|null} [opts.sourceAssignment]
 * @param {object|null} [opts.roster]
 * @param {Map<string, object>|null} [opts.extraLogins]
