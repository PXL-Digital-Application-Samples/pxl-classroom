...
export const CLAIM_REJECTIONS = Object.freeze({
  ...
  // On the roster, but not in a class group this assignment admits. Distinct
  // from NO_MATCH on purpose: "your address is not registered" and "your
  // address is registered to another section" send a student to do different
  // things, and telling them the first when the second is true wastes an email
  // to their lecturer.
  CLASS_GROUP: "rejected:not-in-class-group",
