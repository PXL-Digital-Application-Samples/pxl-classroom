 ...
 *
 * @param {Array<import("./types.mjs").Claim>} claims
 * @returns {{byEmail: Map<string, import("./types.mjs").Claim>,
 *            duplicates: Array<{email: string, claims: Array<import("./types.mjs").Claim>}>}}
 */
 ...
 *
 * @param {import("./types.mjs").RosterStudent} entry roster entry
 * @param {{byEmail: Map<string, import("./types.mjs").Claim>}} index from indexClaims
 * @returns {{state: string, claim: import("./types.mjs").Claim|null, login: string|null,
 *            verified: boolean, rosterLogin: string|null}}
 */
 ...
 *
 * @param {import("./types.mjs").Roster} roster parsed students/roster.yml
 * @param {Array<import("./types.mjs").Claim>} claims
 * @returns {Array<{entry: import("./types.mjs").RosterStudent,
 *                  binding: ReturnType<typeof bindingForEntry>}>}
 */
