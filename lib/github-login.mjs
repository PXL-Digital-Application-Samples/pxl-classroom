 ...
 *
 * @param {Iterable<{github_login?: unknown}>} records
 * @param {(record: any) => unknown} [pick] how to read the login off a record
 * @returns {Map<string, any>} keyed by normalizeLogin
 */
