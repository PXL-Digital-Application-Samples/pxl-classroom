...
/**
 * @param {unknown} token the `<payload>.<signature>` the student's link carries
 * @param {object} [expected]
 * @param {string} [expected.org]
 * @param {string} [expected.assignmentId]
 * @param {string|null} [expected.nonce] the assignment's current nonce, if it has one
 * @param {Record<string|number, string>|null} [expected.publicKeys] kid -> base64url Ed25519 key
 * @param {Date} [expected.now]
