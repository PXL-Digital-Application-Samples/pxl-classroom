...
export const APP_TOKEN_SCOPES = Object.freeze({
  ...
  ".github/workflows/regenerate-dashboard.yml#generate.token": { app: "provisioning", repositories: "all", permissions: "all", pending: "stage 2" },
  ...
  "notify/action.yml#token": { app: "provisioning", repositories: "all", permissions: "all", pending: "stage 2" },
  "report/action.yml#token": { app: "provisioning", repositories: "all", permissions: "all", pending: "stage 2" },
  "registry/action.yml#token": { app: "provisioning", repositories: "all", permissions: "all", pending: "stage 2" },
  "collect/action.yml#token": { app: "provisioning", repositories: "all", permissions: "all", pending: "stage 2" },
