...
/**
 * The month an academic year begins, 1-12.
 *
 * Defaulted rather than required: a fork that never edits it still gets the
 * September convention, and the one thing that reads it - the name suggested
 * when an assignment name is taken - degrades to a suggestion in the wrong
 * year rather than throwing at import.
 */
