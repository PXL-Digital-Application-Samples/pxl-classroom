 ...
 * @param {object|null} edit.before the roster row as stored
 * @param {object|null} edit.after  the roster row the edit would write
 * @param {object[]} edit.assignments full assignment documents, with their `cohort`
 * @returns {{
 *   lost: string[],
