 ...
 *
 * @param {object} edit  the one destructured parameter, not three positional ones
 * @param {import("./types.mjs").RosterStudent|null} edit.before the roster row as stored
 * @param {import("./types.mjs").RosterStudent|null} edit.after  the roster row the edit would write
 * @param {import("./types.mjs").Assignment[]} edit.assignments full assignment documents, with their `cohort`
 * @returns {{
 *   lost: string[],
