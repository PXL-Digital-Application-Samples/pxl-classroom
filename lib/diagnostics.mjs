    ...
    if (assignmentId) {
      ...
      if (acceptors.length) {
        ...
        const finding = unfreezableAcceptorsFinding({
          ...
          ownersComplete,
          org,
          viewerLogin: userRes.data?.login || null,
        });
        if (finding) {
          addCheck(3, check(
            "cohort-freezable",
