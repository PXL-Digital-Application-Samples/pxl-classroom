...
Section numbers are unchanged from when these procedures lived in RUNBOOK.md, so existing references keep resolving.
...
## 6. When onboarding or permissions fail
