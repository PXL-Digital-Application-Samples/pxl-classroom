...
- **Student-Side, graded at hand-in (cloud exams):**
  ...
  - In the assignment: **Autograding → They come with my template → Only on a hand-in commit**, and type the same words. Scores are then read from the newest commit carrying it, not from the student's last commit.
